...
HD_PWD='C:/Users/doguk/Documents/fpga/vivado_proj/nexys_4_ddr_7_segment_/nexys_4_ddr_7_segment_.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ana_kod.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ana_kod.tcl -notrace
